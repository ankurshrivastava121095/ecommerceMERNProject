                ...
                >
                    {
                        Array?.isArray(data) && data?.length > 0 && data.map((val,key)=>(
                            <SwiperSlide key={key}>
                                <div role='button' style={{ width: '130px' }} onClick={()=>navigate(`/sub-category-product/${val?._id}`)}>
                                    <Avatar
                                    ...
                                    />
                                    <div style={{ fontSize: '14px' }}>{val?.subCategoryName}</div>
                                </div>
                            </SwiperSlide>
                        ))
                    }
